...
class FormSubmissionPage:
  ...
  def enter_name(self, name):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", name_input)
  ...
  def enter_email(self, email):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", email_input)
    email_input.send_keys(email)

  def enter_contact(self, contact):
    self.logger.info("Input contact")
    self.logger.debug(f"Locator used: {self.contact_input}")
    contact_input = self.driver.find_element(*self.contact_input)
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", contact_input)
  ...
  def enter_date(self, date):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", date_input)
  ...
  def enter_file(self, file):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", file_input)
  ...
  def enter_color(self, color):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", group_color)
  ...
  def enter_food(self, food):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", group_food)
  ...
  def enter_country(self, country):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", select)
  ...
  def click_submit(self):
    ...
    self.driver.execute_script("arguments[0].scrollIntoView('alignToTop');", submit_button)
    submit_button.click()
